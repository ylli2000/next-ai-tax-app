...
/**
 * Sign in page for testing NextAuth functionality
 *
 * This page provides basic OAuth sign-in buttons to test:
 * - Google OAuth integration
 * - GitHub OAuth integration
 * - NextAuth session creation
 * - Database user creation via Drizzle adapter
 */
                ...
                <div className="mt-8 space-y-4">
                    ...
                    <div className="mt-6 p-4 bg-blue-50 rounded-md">
                        ...
                        <div className="mt-2 text-xs text-blue-600">
                            ...
                            <p>
                                • Database user creation will be automatic via
                                Drizzle adapter
                            </p>
                        </div>
                    </div>
