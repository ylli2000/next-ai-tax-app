...
一款基于AI的智能发票管理系统，专为繁忙的小企业主和会计师设计。用户只需上传PDF或图片，系统即可自动提取发票信息、智能分类、异常检测，并提供灵活的数据分析和导出功能。作为税务管理生态系统的第一阶段，为未来的税务计算和申报功能奠定坚实基础。

## 👥 目标用户

### 主要用户群体
- **小企业主** 📊：需要高效管理日常发票，为税务申报做准备
- **会计师/财务人员** 💼：需要批量处理多个客户的发票数据
- **自由职业者** 🎯：需要整理业务相关的发票和支出
